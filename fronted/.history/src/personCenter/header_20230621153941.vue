      ...
      <table class="settings">
        <tbody>
          ...
          <tr>
            ...
            <td valign="top" align="left">
              <input type="text" v-model="visit.name" style="height: 30px;width: 600px;border-radius: 10px;border-color: hotpink;">
            </td>
          </tr>
          <tr>
            <td valign="top" width="12%" style="text-align: middle;font-size: 20px;">密码</td>
            <td valign="top" align="left">
              <input type="text" v-model="visit.password" style="height: 30px;width: 600px;border-radius: 10px;border-color: hotpink;">
            </td>
          </tr>
          <tr>
            ...
            <td valign="top" align="left">
              ...
              <input type="file" name="选择图片" style="position: relative; left: 20px;border-radius: 5px;border-color: lightblue;">
            </td>
          </tr>
          <tr>
            <td valign="top"><input type="submit" value="提交修改信息"></td>
          </tr>
        </tbody>
      </table>
    </form>
