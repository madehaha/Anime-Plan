    ...
    <div class="comic">
      ...
      <el-tabs type="card" class="demo-tabs">
        <el-tab-pane
          ...
          <div class="content">
            <el-scrollbar max-height="400px">
              <want v-for="(item, index) in wantedList" :key="item.id" :item="item" />
            </el-scrollbar>
          </div>
        </el-tab-pane>
        <el-tab-pane>
          ...
          <div class="content">
            <el-scrollbar max-height="400px">
              <seen v-for="(item, index) in seenList" :key="item.id" :item="item" />
            </el-scrollbar>
          </div>
        </el-tab-pane>
        <el-tab-pane>
          ...
          <div class="content">
            <el-scrollbar max-height="400px">
              <watching v-for="(item, index) in watchingList" :key="item.id" :item="item" />
            </el-scrollbar></div
        ></el-tab-pane>
        <el-tab-pane>
          <template #label>
          ...
          <div class="content">
            <el-scrollbar max-height="400px">
              <shelve v-for="(item, index) in shelvedList" :key="item.id" :item="item" />
        ...
        <el-tab-pane>
          ...
          <div class="content">
            <el-scrollbar max-height="400px">
              <discard v-for="(item, index) in discardList" :key="item.id" :item="item" />
            </el-scrollbar></div
        ></el-tab-pane>
      </el-tabs>
    </div>
