...
service
  ...
  const collect = ref(wantedCount.value+seenCount.value+watchingCount.value+shelvedCount.value+discardCount.value)
const finish = ref(seenCount.value)
const finishRate = ref(seenCount.value/collect.value)
