<template>
  ...
  <div class="all2">
    <div class="content">
     <div class="collect">
      <div class="data1">{{ collect }}</div>
      <div class="txt">收藏</div>
     </div>
     <div class="finish">
      <div class="data1">{{ finish }}</div>
      <div class="txt">完成</div>
     </div>
     <div class="finishRate">
      <div class="data1">{{ finishRate }}</div>
      <div class="txt">完成率</div>
     </div>
     <div class="average">
      <div class="data1">{{ average }}</div>
      <div class="txt">平均分</div>
     </div>
     <div class="gradeCount">
      <div class="data1">{{ gradeCount }}</div>
      <div class="txt">评分数</div>
     </div>
    </div>
  </div>
</template>
...
const collect = computed(() => wantedCount.value+seenCount.value+watchingCount.value+shelvedCount.value+discardCount.value)
const finish = ref(seenCount)
const finishRate = computed(() => (seenCount.value * 100/collect.value).toString().split("").slice(0,4).join("") + "%")
const average = ref('6.29')
