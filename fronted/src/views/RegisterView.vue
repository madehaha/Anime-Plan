        ...
        <form action="#" class="form_style">
          ...
          <div class="form">
           ...
           <input id="Name" 
                  ...
                  type="text" 
                  v-model.trim="this.name" 
                  @focus="Reset($event)"
            />
          <div id="dName" style="visibility: hidden;height: 20px;"><p class="err"></p></div>
          </div>   
          ...
          <div class="form">
           ...
           <input id="Email" 
                  placeholder="Email" 
                  type="email" 
                  v-model.trim="this.mail" 
                  @focus="Reset($event)"
            />
           <div id="dEmail" style="visibility:hidden;height: 20px;"><p class="err"></p></div>
          </div>
          ...
          <div class="form">
           ...
           <input id="Password" 
                  ...
                  @focus="Reset($event)"
            />
           <div id="dPassword" style="visibility: hidden;height: 20px;"><p  id="err1" class="err"></p></div>
          </div>
          ...
          <div class="form">
           ...
           <input id="NewPassword" 
                  ...
                  @focus="Reset($event)"
            />
           <div id="dNewPassword" style="visibility: hidden;height: 20px;" ><p class="err"></p></div>
          </div>
          ...
          <div class="form">
           ...
           <input id="Telephone" 
                  ...
                  type="tel" 
                  v-model.trim="this.tel"
                  @focus="Reset($event)"
            />
           <div id="dTelephone" style="visibility: hidden;height: 20px;"><p class="err"></p></div>
          </div>
            
          <button @click.prevent="handlefinish">提交</button>
        </form>
      <div class="rg_right">
            <p style="color: black;">已有账号？<a @click.prevent="ReturnToLogin" style="color:darkcyan;">登录</a></p>
      </div>
      </div>
...
const TelEmpty=()=>{
  ...
  tel.firstChild.innerHTML="请输入电话号码";
