<template>
  <div class="nav">
    <div class="nav-top">
      ...
      <span class="home" @click="ToPerson" style="float:right; margin-right: 160px;" v-if= "isLogin" >
       <img class="logo-img" src="../assets/home.png"/>
       <p >个人中心</p>
      </span>
      <span class="home" @click="ToRegister" style="float:right; margin-right: 160px;" v-else>
       <img class="logo-img" src="../assets/home.png"/>
       <p >登录/注册</p>
      </span>
      ...
      <span class="home" style="float: right;">
       ...
       <button class="nav-button">搜索</button>
      </span>
    </div>
  </div>
